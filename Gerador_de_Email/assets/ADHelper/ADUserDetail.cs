    ...
    public class ADUserDetail
    {
        ...
        public ADUserDetail Manager
        {
            get
            {
                ...
                {
                    ADConfig aux = config;
                    ActiveDirectoryHelper ad = new ActiveDirectoryHelper(ref aux);
        ...
        public static ADConfig config { get; set; }

        private ADUserDetail(DirectoryEntry directoryUser, ADConfig aux)
        {
            config = aux;
        ...
        {
            return new ADUserDetail(directoryUser, config);
        }
    }
}